...
\begin{figure}[h!]
    \RawFloats
    \centering
    \includegraphics[scale=.25]{part-automl/chapter-supervised/img-hamlet/accuracy_time.pdf}
    \caption{Results assessing the performance of HAMLET through the optimization time.}
    \label{fig:efficiency}
    \includegraphics[scale=.25]{part-automl/chapter-supervised/img-hamlet/skyline.pdf}
