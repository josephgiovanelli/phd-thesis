...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1.0\textwidth]{part-automl/chapter-supervised/img/data-analytics-pipeline.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{part-automl/chapter-supervised/img/pre-processing-impact.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{part-automl/chapter-supervised/img/evaluation1.pdf}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.7\textwidth]{part-automl/chapter-supervised/img/evaluation2.pdf}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=1.0\textwidth]{part-automl/chapter-supervised/img/barplot-10.pdf}
