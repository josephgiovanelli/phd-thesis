...
\begin{figure}[t]
    ...
    \caption{Overview of AutoClues.\todo{Adattare stile}}
...
\end{equation}
where $rel$ is a goodness metric for the clustering $C$ obtained by partitioning the dataset through the pipeline at hand $P_{\lambda}(\altmathcal{D})$.\todo{Cambierei in <P, A>}
...
\todo{Qua ci starebbe bene la definizione formale dell'AMI (e delle altre come sil, dbi, ch), tipo come con accuracy}
