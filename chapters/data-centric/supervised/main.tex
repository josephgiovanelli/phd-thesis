...
In particular, in \Cref{tbl:validation-rules}, the first two columns denote the pipeline instantiations for the respective pairs of steps (i.e., $\langle S_1, S_2 \rangle$ and $\langle S_2, S_1 \rangle$).
