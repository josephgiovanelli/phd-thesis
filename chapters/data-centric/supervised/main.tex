...
\todo{Non dire che l'acc è dell'algoritmo ma della pipeline}
...
\begin{figure*}[!t]
	...
	\caption{The impact of dedicating a portion of the optimization budget to pre-processing compared to using the whole optimization budget for the hyperparameter optimization.\todo{Migliorare}}
