\chapter{An Auto-Tuning 3D Process-Based Model Coupled with Data Assimilation}
...
% Such a modeling paradigm was heavily employed in the case of crop modeling, for instance, processes in these cases might implement hydraulic fluxes, evapotranspiration

\begin{definition}[Crop model \cite{Buck-Sorlin2013}]
...
\end{itemize}
\todo{Mancano diverse cose: 1. tecniche automl utilizzate per parameter tuning, 2. come si collega a physics-aware/couples AI (devo richiamarlo somehow)}
