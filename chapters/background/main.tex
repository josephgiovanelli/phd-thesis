...
According to the task at hand, the goodness of an ML pipeline -- and thus the data pipeline within -- can be evaluated via the aforementioned loss functions $\altmathcal{L}$\footnote---e.g., misclassification error for supervised classification tasks, silhouette index for unsupervised clustering tasks.
