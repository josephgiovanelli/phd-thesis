...
Authors provide also other state-of-the-art BO implementations; for instance, in \cite{falkner2018bohb}, they propose bayesian optimization and hyper band (BOHB), which enhances the global exploration capabilities of BO with the efficient resource utilization of multi-fidelity functions.
